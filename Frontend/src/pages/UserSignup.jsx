...
const UserSignup = () => {
  ...
  return (
    ...
    <p className="text-center">Have an Account? <Link to="/login" className="text-blue-600 text-sm">Find my account</Link> </p>
        ...
        <Link to="/Captain-Signup" className="w-full bg-black flex items-center justify-center text-white py-2 rounded-md text-m mb-4 mt-4">
          Sign in as Captain
        </Link>
